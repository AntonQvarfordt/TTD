...
namespace WhiteCat.Paths
{
	...
	public partial class CardinalPath
	{
		...
		void DrawNodeUI(Rect rect)
		{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.prevTexture, "Previous node"), EditorUI.buttonLeftStyle))
			{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.nextTexture, "Next node"), EditorUI.buttonRightStyle))
			{
