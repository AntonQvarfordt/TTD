	...
	public partial class BezierPath
	{
		...
		protected override void DrawSceneControls()
		{
			...
			if (_selectionType != SelectionType.None)
			{
				...
				Handles.BeginGUI();
				EditorUI.BeginGUIColor(_haloColor);
		...
		void DrawSplineControls()
		{
			...
			{
				EditorUI.BeginHotControlChangeCheck();
...
#endif
				if (EditorUI.EndHotControlChangeCheck() == HotControlEvent.MouseDown)
				{
		...
		void DrawNodeControls(bool edit)
		{
			...
			for (int i = 0; i < _count; i++)
			{
				...
				EditorUI.HandlesDrawAALine(_back, _middle);
				EditorUI.HandlesDrawAALine(_forward, _middle);
		...
		void DrawSplineUI(Rect rect)
		{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.insertNodeTexture, "Insert node"), EditorUI.buttonStyle))
			{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.prevTexture, "Previous segment"), EditorUI.buttonLeftStyle))
			{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.nextTexture, "Next segment"), EditorUI.buttonRightStyle))
			{
		...
		void DrawForwardControlPointUI(Rect rect)
		{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.prevTexture, "Previous forward control point"), EditorUI.buttonLeftStyle))
			{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.nextTexture, "Next forward control point"), EditorUI.buttonRightStyle))
			{
		...
		void DrawBackControlPointUI(Rect rect)
		{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.prevTexture, "Previous back control point"), EditorUI.buttonLeftStyle))
			{
				_selectedItem = (_selectedItem == 0) ? (nodeCount - 1) : (_selectedItem - 1);
			}
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.nextTexture, "Next back control point"), EditorUI.buttonRightStyle))
			{
				_selectedItem = (_selectedItem == nodeCount - 1) ? 0 : (_selectedItem + 1);
			}
		}
		...
		void DrawMiddleControlPointUI(Rect rect)
		{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.insertNodeBackTexture, "Insert Back"), EditorUI.buttonLeftStyle))
			{
				Undo.RecordObject(this, "Insert Node");
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.insertNodeForwardTexture, "Insert Forward"), EditorUI.buttonRightStyle))
			{
				Undo.RecordObject(this, "Insert Node");
				InsertNode(_selectedItem += 1);
				EditorUtility.SetDirty(this);
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.removeNodeTexture, "Remove node"), EditorUI.buttonStyle))
			{
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.prevTexture, "Previous middle control point"), EditorUI.buttonLeftStyle))
			{
				_selectedItem = (_selectedItem == 0) ? (nodeCount - 1) : (_selectedItem - 1);
			}
			...
			if (GUI.Button(rect, EditorUI.TempContent(null, EditorAssets.nextTexture, "Next middle control point"), EditorUI.buttonRightStyle))
			{
				_selectedItem = (_selectedItem == nodeCount - 1) ? 0 : (_selectedItem + 1);
			}
		}
