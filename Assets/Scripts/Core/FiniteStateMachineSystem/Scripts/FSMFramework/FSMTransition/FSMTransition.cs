...
public class FSMTransition
{
    ...
    /// </summary>
    private string m_FSMTransitionName;

    public string FSMTransitionName
    {
        get { return m_FSMTransitionName; }
        set { m_FSMTransitionName = value; }
    }
    ...
    /// </summary>
    public FSMTransition(FSMState fsmState, FSMState nextFSMState, IFSMTransitionCondition[] fsmTransitionConditionArray)
    {
        this.m_FSMTransitionName = string.Format("{0}->{1}", fsmState.FSMStateName, nextFSMState.FSMStateName);
