...
public abstract class FSMState
{
    ...
    /// <summary>
    /// The constructor of this state
    /// </summary>
    /// <param name="fsmStateName">The name of this state</param>
    public FSMState(string fsmStateName)
    {
        this.m_FSMStateName = fsmStateName;
    }
    ...
    public FSMTransition AddTransition(FSMState nextFSMState, IFSMTransitionCondition[] fsmTransitionConditionArray)
    {
        ...
        FSMTransition fsmTransition = new FSMTransition(this, nextFSMState, fsmTransitionConditionArray);
    ...
    public void DeleteTransition(FSMTransition fSMTransition)
    {
        ...
        {
            Debug.LogErrorFormat("{0} do not have the fSMTransition : {1}", this.m_FSMStateName, fSMTransition.FSMTransitionName);
        }
    }
